...
from utils.GDINO.groundingdino.util.inference import load_model, load_image, predict, annotate, Model, get_box
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="outputs1", help="output directory")
